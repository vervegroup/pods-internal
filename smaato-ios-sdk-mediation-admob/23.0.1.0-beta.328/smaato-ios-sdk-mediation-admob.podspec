...
s.platform         = :ios, '12.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/ios-sdk-mediation-admob.git", :tag => '23.0.1.0-beta.328' }
...
s.subspec 'Adapters' do |adapters|
    adapters.dependency "smaato-ios-sdk", "23.0.1"
