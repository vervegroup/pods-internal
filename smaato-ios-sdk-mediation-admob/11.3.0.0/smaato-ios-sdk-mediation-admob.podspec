...
s.platform         = :ios, '12.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/ios-sdk-mediation-admob.git", :tag => '11.3.0.0' }
...
s.subspec 'Adapters' do |adapters|
    adapters.dependency "smaato-ios-sdk","22.9.2-beta.93"
