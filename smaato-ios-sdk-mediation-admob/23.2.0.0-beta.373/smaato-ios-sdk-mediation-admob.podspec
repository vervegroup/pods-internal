...
s.platform         = :ios, '12.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/ios-sdk-mediation-admob.git", :tag => s.version.to_s }
...
s.subspec 'Adapters' do |adapters|
    adapters.dependency "smaato-ios-sdk", "23.1.0"
