...
s.platform         = :ios, '12.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/smaato/ios-sdk-mediation-admob.git", :tag => '11.0.1.0' }
s.default_subspecs = 'Adapters'
s.static_framework = true
s.xcconfig = { 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'i386' }
s.dependency "Google-Mobile-Ads-SDK", "11.0.1"

s.subspec 'Adapters' do |adapters|
    adapters.dependency "smaato-ios-sdk", ">= 22.7.0"
