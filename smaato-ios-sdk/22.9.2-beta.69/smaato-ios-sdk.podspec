...
s.platform         = :ios, '11.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/Smaato-ios-sdk-standalone.git" , :tag => '22.9.2-beta.69' }
...
s.subspec 'Modules' do |m|
    ...
    m.subspec 'Core' do |core|
      ...
      core.vendored_frameworks = 'SmaatoSDKCore.xcframework'
