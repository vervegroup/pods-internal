...
s.platform         = :ios, '12.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/Smaato-ios-sdk-standalone.git" , :tag => '23.0.0-beta.211' }
...
s.subspec 'Modules' do |m|
    ...
    m.subspec 'Core' do |core|
      ...
      core.dependency 'ATOM-Standalone-Private', '3.7.0-beta.15'
