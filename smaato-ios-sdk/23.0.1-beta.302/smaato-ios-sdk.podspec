...
s.platform         = :ios, '12.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/Smaato-ios-sdk-standalone.git" , :tag => '23.0.1-beta.302' }
...
s.subspec 'Modules' do |m|
    ...
    m.subspec 'Core' do |core|
      ...
      core.dependency 'ATOM-Standalone'
      core.vendored_frameworks = ['SmaatoSDKCore.xcframework', 'NGSDK.xcframework', 'OMSDK-Smaato-1.6.3/OMSDK_Smaato.xcframework']
    end
