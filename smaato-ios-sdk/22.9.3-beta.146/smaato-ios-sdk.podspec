...
s.platform         = :ios, '11.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/Smaato-ios-sdk-standalone.git" , :tag => '22.9.3-beta.146' }
...
s.subspec 'Modules' do |m|
    ...
    m.subspec 'Core' do |core|
      core.xcconfig = { 'OTHER_LDFLAGS' => '-ObjC' }
            core.vendored_frameworks = ['SmaatoSDKCore.xcframework', 'Smaato_HyBid.xcframework', 'OMSDK-Smaato-1.5.2/OMSDK_Smaato.xcframework', 'OMSDK-1.5.2/OMSDK_Pubnativenet.xcframework', 'ATOM.xcframework']
    end
