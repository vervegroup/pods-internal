Pod::Spec.new do |s|
  s.name         = "SmaatoSnapshotTestCase"
  s.module_name  = "FBSnapshotTestCase"
  s.version      = "6.1.5"
  s.summary      = "Snapshot view unit tests for iOS"
  s.description  = <<-DESC
                    A "snapshot test case" takes a configured UIView, UIImage or CALayer
                   ...
                   DESC
  s.homepage     = "https://bitbucket.smaato.net/projects/NGSDK/repos/iossnapshottestcase/browse"
  s.license      = 'MIT'
  s.author       = 'Uber'
  s.source       = { :git => "ssh://git@bitbucket.smaato.net:7999/ngsdk/iossnapshottestcase.git",
                     :tag => s.version.to_s }
  ...
  s.subspec 'SwiftSupport' do |cs|
    cs.dependency 'SmaatoSnapshotTestCase/Core'
