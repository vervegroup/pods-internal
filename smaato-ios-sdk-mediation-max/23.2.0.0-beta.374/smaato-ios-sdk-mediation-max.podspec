Pod::Spec.new do |s|
s.name             = "smaato-ios-sdk-mediation-max"
s.version          = "23.2.0.0-beta.374"
...
s.platform         = :ios, '12.0'
s.requires_arc     = true
s.source           = { :git => "https://github.com/vervegroup/smaato-ios-sdk-mediation-applovin.git", :tag => s.version.to_s }
