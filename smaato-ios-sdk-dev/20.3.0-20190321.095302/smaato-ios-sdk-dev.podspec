...
s.version          = "20.3.0-20190321.095302"
...
s.platform         = :ios, '8.0'
s.requires_arc     = true
s.source           = { :http => "https://s3.amazonaws.com/smaato-sdk-releases-internal/ios/smaato-ios-sdk-20.3.0-20190321.095302.zip" }
...
s.subspec 'Modules' do |m|
    ...
    m.subspec 'HeaderBidding' do |headerbidding|
      headerbidding.dependency 'mopub-ios-sdk'
      headerbidding.dependency 'smaato-ios-sdk-dev/Modules/Core'
      headerbidding.vendored_frameworks = 'SmaatoSDKHeaderBidding.framework'
    end
...
s.subspec 'Adapters' do |a|

    a.subspec 'MoPub' do |m|
        m.dependency 'mopub-ios-sdk'

        m.subspec 'Banner' do |b|
            b.dependency 'smaato-ios-sdk-dev/Modules/Banner'
            b.source_files = 'SmaatoSDKAdapters/MoPub/Banner/*.{h,m}'
        end

        m.subspec 'Interstitial' do |i|
            i.dependency 'smaato-ios-sdk-dev/Modules/Interstitial'
            i.source_files = 'SmaatoSDKAdapters/MoPub/Interstitial/*.{h,m}'
        end

        m.subspec 'RewardedVideo' do |r|
            r.dependency 'smaato-ios-sdk-dev/Modules/RewardedAds'
            r.source_files = 'SmaatoSDKAdapters/MoPub/RewardedVideo/*.{h,m}'
        end
    end

    a.subspec 'AdMob' do |a|
        a.dependency 'Google-Mobile-Ads-SDK'

        a.subspec 'Banner' do |b|
            b.dependency 'smaato-ios-sdk-dev/Modules/Banner'
            b.source_files = 'SmaatoSDKAdapters/AdMob/Banner/*.{h,m}'
        end

        a.subspec 'Interstitial' do |i|
            i.dependency 'smaato-ios-sdk-dev/Modules/Interstitial'
            i.source_files = 'SmaatoSDKAdapters/AdMob/Interstitial/*.{h,m}'
        end

        a.subspec 'RewardedVideo' do |r|
            r.dependency 'smaato-ios-sdk-dev/Modules/RewardedAds'
            r.source_files = 'SmaatoSDKAdapters/AdMob/RewardedVideo/*.{h,m}'
        end
    end
end
