...
s.version          = "0.1.0-20180921.090522"
...
s.platform         = :ios, '8.0'
s.requires_arc     = true
s.source           = { :http => "https://s3.amazonaws.com/smaato-sdk-releases-internal/ios/smaato-ios-sdk-0.1.0-20180921.090522.zip" }
...
s.subspec 'Core' do |core|
  ...
  core.weak_frameworks = 'SafariServices','CoreLocation'
end
