...
s.version          = "0.1.0-20180713.152018"
...
s.platform         = :ios, '8.0'
s.requires_arc     = true
s.source           = { :http => "https://s3.amazonaws.com/smaato-sdk-releases-internal/ios/smaato-ios-sdk-0.1.0-20180713.152018.zip" }
...
s.subspec 'Core' do |core|
  core.frameworks = ["AdSupport", "CoreLocation", "CoreTelephony", "Foundation", "SafariServices", "StoreKit", "UIKit", "WebKit"]
...
s.subspec 'Vast' do |vast|
  ...
  vast.vendored_frameworks = 'SomaVAST.framework'
end
